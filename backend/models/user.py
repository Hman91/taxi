...
class User(db.Model):
    ...
    approval_status = db.Column(String(16), nullable=False, server_default="approved")
    approved_at = db.Column(DateTime(timezone=True), nullable=True)
    approved_by_user_id = db.Column(db.BigInteger, nullable=True)
