...
class TaxiAppService {
  ...
  Future<Map<String, dynamic>> getPassengerMe({required String token}) =>
      _client.getPassengerMe(token: token);

  Future<Map<String, dynamic>> patchPassengerMe({
    required String token,
    required Map<String, dynamic> body,
  }) =>
      _client.patchPassengerMe(token: token, body: body);
