...
class AuthTokenStore {
  ...
  String? accessToken;
  String? refreshToken;
  /// B2B legacy: role-only token for endpoints that do not require `uid`.
  ...
  /// Prefer in-memory store (post-refresh); fall back to widget-held token.
  ...
  /// Refresh before access expiry when a refresh token exists.
